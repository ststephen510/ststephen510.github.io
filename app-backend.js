...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function handleSearch() {
        ...
        try {
            ...
            addMessage(`Error: ${error.message}. Please deploy the backend first (see VERCEL_SETUP.md)`, 'bot-message');
    ...
    function displayError(message) {
        ...
        jobResults.innerHTML = `
            <div class="error-message">
                ...
                <br><br>
                <small>Please follow the instructions in VERCEL_SETUP.md to deploy the backend.</small>
            </div>
        `;
    }
